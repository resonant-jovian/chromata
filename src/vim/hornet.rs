...
pub const THEME: Theme = Theme {
    ...
    string: Some(Color::from_hex(0xfecf35)),
    function: Some(Color::from_hex(0xfdb32a)),
    variable: Some(Color::from_hex(0xb1d631)),
    r#type: Some(Color::from_hex(0x7e8aa2)),
    constant: Some(Color::from_hex(0xc03000)),
    operator: None,
    tag: None,
    error: None,
    warning: None,
    ...
    red: None,
    orange: None,
    yellow: Some(Color::from_hex(0x4bb5c1)),
    green: Some(Color::from_hex(0xfecf35)),
    cyan: Some(Color::from_hex(0x7e8aa2)),
    blue: Some(Color::from_hex(0xfdb32a)),
    purple: Some(Color::from_hex(0xff9800)),
    magenta: Some(Color::from_hex(0x96ca2d)),
};
