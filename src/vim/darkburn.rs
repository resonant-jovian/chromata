...
pub const THEME: Theme = Theme {
    ...
    selection: Some(Color::from_hex(0x233323)),
    ...
    string: Some(Color::from_hex(0xb75151)),
    function: Some(Color::from_hex(0xefef8f)),
    variable: Some(Color::from_hex(0xdcdcdc)),
