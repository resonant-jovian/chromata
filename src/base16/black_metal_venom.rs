...
pub const THEME: Theme = Theme {
    name: Cow::Borrowed("Black Metal (Venom)"),
    ...
    warning: Some(Color::from_hex(0x79241f)),
    info: Some(Color::from_hex(0x888888)),
    success: Some(Color::from_hex(0xf8f7f2)),
    red: Some(Color::from_hex(0x5f8787)),
    orange: Some(Color::from_hex(0xaaaaaa)),
    yellow: Some(Color::from_hex(0x79241f)),
    green: Some(Color::from_hex(0xf8f7f2)),
