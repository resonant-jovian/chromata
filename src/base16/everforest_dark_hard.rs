//! Everforest Dark Hard color theme.
//!
...
pub const THEME: Theme = Theme {
    name: Cow::Borrowed("Everforest Dark Hard"),
    author: Cow::Borrowed("Sainnhe Park (https://github.com/sainnhe)"),
    variant: Variant::Dark,
    contrast: Contrast::Normal,
    bg: Color::from_hex(0x272e33),
    fg: Color::from_hex(0xd3c6aa),
    cursor: Some(Color::from_hex(0xd3c6aa)),
    selection: Some(Color::from_hex(0x414b50)),
    line_highlight: Some(Color::from_hex(0x2e383c)),
    gutter: Some(Color::from_hex(0x859289)),
    statusbar_bg: Some(Color::from_hex(0x2e383c)),
