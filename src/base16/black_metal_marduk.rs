//! Black Metal (Marduk) color theme.
//!
...
pub const THEME: Theme = Theme {
    name: Cow::Borrowed("Black Metal (Marduk)"),
    ...
    warning: Some(Color::from_hex(0x626b67)),
    info: Some(Color::from_hex(0x888888)),
    success: Some(Color::from_hex(0xa5aaa7)),
    red: Some(Color::from_hex(0x5f8787)),
    orange: Some(Color::from_hex(0xaaaaaa)),
    yellow: Some(Color::from_hex(0x626b67)),
    green: Some(Color::from_hex(0xa5aaa7)),
