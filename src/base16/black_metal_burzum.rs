//! Black Metal (Burzum) color theme.
//!
...
pub const THEME: Theme = Theme {
    name: Cow::Borrowed("Black Metal (Burzum)"),
    ...
    warning: Some(Color::from_hex(0x99bbaa)),
    info: Some(Color::from_hex(0x888888)),
    success: Some(Color::from_hex(0xddeecc)),
    red: Some(Color::from_hex(0x5f8787)),
    orange: Some(Color::from_hex(0xaaaaaa)),
    yellow: Some(Color::from_hex(0x99bbaa)),
    green: Some(Color::from_hex(0xddeecc)),
