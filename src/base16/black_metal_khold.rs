...
pub const THEME: Theme = Theme {
    name: Cow::Borrowed("Black Metal (Khold)"),
    ...
    warning: Some(Color::from_hex(0x974b46)),
    info: Some(Color::from_hex(0x888888)),
    success: Some(Color::from_hex(0xeceee3)),
    red: Some(Color::from_hex(0x5f8787)),
    orange: Some(Color::from_hex(0xaaaaaa)),
    yellow: Some(Color::from_hex(0x974b46)),
    green: Some(Color::from_hex(0xeceee3)),
