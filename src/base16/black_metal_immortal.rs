//! Black Metal (Immortal) color theme.
//!
...
pub const THEME: Theme = Theme {
    name: Cow::Borrowed("Black Metal (Immortal)"),
    ...
    string: Some(Color::from_hex(0x7799bb)),
    ...
    warning: Some(Color::from_hex(0x556677)),
    info: Some(Color::from_hex(0x888888)),
    success: Some(Color::from_hex(0x7799bb)),
    red: Some(Color::from_hex(0x5f8787)),
    orange: Some(Color::from_hex(0xaaaaaa)),
    yellow: Some(Color::from_hex(0x556677)),
    green: Some(Color::from_hex(0x7799bb)),
