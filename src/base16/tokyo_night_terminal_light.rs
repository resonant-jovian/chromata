//! Tokyo Night Terminal Light color theme.
//!
...
pub const THEME: Theme = Theme {
    name: Cow::Borrowed("Tokyo Night Terminal Light"),
    author: Cow::Borrowed("Michaël Ball"),
    variant: Variant::Light,
    contrast: Contrast::Normal,
    bg: Color::from_hex(0xd5d6db),
    fg: Color::from_hex(0x4c505e),
    cursor: Some(Color::from_hex(0x4c505e)),
    ...
    operator: Some(Color::from_hex(0x4c505e)),
    ...
    magenta: Some(Color::from_hex(0x655259)),
};
