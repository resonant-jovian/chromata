...
pub const THEME: Theme = Theme {
    name: Cow::Borrowed("Classic Light"),
    author: Cow::Borrowed("Jason Heeris (http://heeris.id.au)"),
    variant: Variant::Light,
    contrast: Contrast::High,
    bg: Color::from_hex(0xf5f5f5),
    fg: Color::from_hex(0x303030),
    cursor: Some(Color::from_hex(0x303030)),
    ...
    operator: Some(Color::from_hex(0x303030)),
