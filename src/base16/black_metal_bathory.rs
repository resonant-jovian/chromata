//! Black Metal (Bathory) color theme.
//!
...
pub const THEME: Theme = Theme {
    name: Cow::Borrowed("Black Metal (Bathory)"),
    ...
    warning: Some(Color::from_hex(0xe78a53)),
    info: Some(Color::from_hex(0x888888)),
    success: Some(Color::from_hex(0xfbcb97)),
    red: Some(Color::from_hex(0x5f8787)),
    orange: Some(Color::from_hex(0xaaaaaa)),
    yellow: Some(Color::from_hex(0xe78a53)),
    green: Some(Color::from_hex(0xfbcb97)),
