//! Black Metal (Dark Funeral) color theme.
//!
...
pub const THEME: Theme = Theme {
    name: Cow::Borrowed("Black Metal (Dark Funeral)"),
    ...
    warning: Some(Color::from_hex(0x5f81a5)),
    info: Some(Color::from_hex(0x888888)),
    success: Some(Color::from_hex(0xd0dfee)),
    red: Some(Color::from_hex(0x5f8787)),
    orange: Some(Color::from_hex(0xaaaaaa)),
    yellow: Some(Color::from_hex(0x5f81a5)),
    green: Some(Color::from_hex(0xd0dfee)),
