...
pub const THEME: Theme = Theme {
    ...
    warning: Some(Color::from_hex(0xa06666)),
    info: Some(Color::from_hex(0x888888)),
    success: Some(Color::from_hex(0xdd9999)),
    red: Some(Color::from_hex(0x5f8787)),
    orange: Some(Color::from_hex(0xaaaaaa)),
    yellow: Some(Color::from_hex(0xa06666)),
    green: Some(Color::from_hex(0xdd9999)),
