//! Gruvbox Material Dark, Soft color theme.
//!
...
pub const THEME: Theme = Theme {
    name: Cow::Borrowed("Gruvbox Material Dark, Soft"),
    author: Cow::Borrowed(
